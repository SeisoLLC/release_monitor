...
LOG = getLogger("release_monitor.invoke")
...
def update(_c, debug=False):
    """Update the core components of release_monitor"""
    if debug:
        getLogger().setLevel("DEBUG")
...
def release(_c, debug=False):
    """Make a new release of release_monitor"""
    if debug:
        getLogger().setLevel("DEBUG")
